...
function updateArticle() {
  ...
  const koreaFrame =
    document.getElementById("koreaFrame");

  const koreaTitle =
    document.getElementById("koreaTitle");

  const koreaLink =
    document.getElementById("koreaLink");
...
document.addEventListener(
  ...
  function () {
    ...
    // Initial Korea.net article
    updateArticle();


    // Elements with data-event attribute
    ...
    trackedElements.forEach(function (element) {
      ...
      element.addEventListener(
        ...
        function () {
          ...
          // If Korea.net article was clicked,
          // also record which article
